...
|              |                         |                                       |                                  |
| -   9 Male   |                         | -   Inertial Measurement Units (IMUs) | -   Peak toe pressure            |
|              |                         |                                       |                                  |
| -   1 Female |                         |                                       | Health:                          |
|              |                         |                                       |                                  |
...
p <- withinSubPlot(psCOM_UH, colName = 'COMWork_pos', dir = 'lower')
...
p <- withinSubPlot(ngCOM_DH, colName = 'COMWork_neg', dir = 'higher')
