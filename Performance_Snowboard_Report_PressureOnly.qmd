...
extractVals(heeldat, heelmod, otherConfigs, baseline, 'heelContact', 'higher') 
...
extractVals(avgDorsaldat, avgDorsalmod, otherConfigs, baseline, 'meanDorsalPressure', 'higher')
```
...
extractVals(normpkDordat , normpkDormod, otherConfigs, baseline, 'normpkDor', 'lower')
```
...
extractVals(maxDorsaldat, maxDorsalmod, otherConfigs, baseline, 'maxDorsalPressure', 'lower')
```
...
extractVals(varDorsaldat, varDorsalmod, otherConfigs, baseline, 'covDorsalPressure', 'lower')
```
...
extractVals(normpkShindat, normpkShinmod, otherConfigs, baseline, 'normpkShin', 'lower')
```
...
extractVals(normpkCalfdat, normpkCalfdatmod , otherConfigs, baseline, 'normpkCalf', 'lower')
...
extractVals(calfCondat, calfCondatmod , otherConfigs, baseline, 'calfContact', 'higher')
```
