...
ev_ToeMax <- extractVals(toemaxDat, toemaxMod, otherConfigs, baseline, 'maxmaxToes', 'lower')

es_ToeMax <- EffectSizeLM(toemaxDat, 'maxmaxToes ~ Config + Order + (Config|Subject)')
checkEffectMagnitude(ev_ToeMax, es_ToeMax, baseline)
```
...
ev_HeelCon <- extractVals(heelConDat, heelConMod, otherConfigs, baseline, 'heelArea_Up', 'higher')

es_HeelCon <- EffectSizeLM(heelConDat, 'heelArea_Up ~ Config + Order + (Config|Subject)')
...
ev_CovDorPress <- extractVals(covDorPress, covDorPressMod, otherConfigs, baseline, 'covDorsalPressure', 'lower')

es_CovDorPress <- EffectSizeLM(covDorPress, 'covDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_CovDorPress, es_CovDorPress, baseline)
```
...
ev_PeakDorPress <- extractVals(peakDorPress, peakDorPressMod, otherConfigs, baseline, 'maxDorsalPressure', 'lower')

es_PeakDorPress <- EffectSizeLM(peakDorPress, 'maxDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_PeakDorPress, es_PeakDorPress, baseline)
```
...
ev_AvgDorPress <- extractVals(avgDorPress, avgDorPressMod, otherConfigs, baseline, 'meanDorsalPressure', 'higher')

es_AvgDorPress <- EffectSizeLM(avgDorPress, 'meanDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_AvgDorPress, es_AvgDorPress, baseline)
```
...
ev_InstDorsal <- extractVals(staticDat_instPres, instDorsalMod, otherConfigs, baseline, 'instepDorsalPressure', 'higher')

es_InstDorsal <- EffectSizeLM(staticDat_instPres, 'instepDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_InstDorsal, es_InstDorsal, baseline)
```
...
ev_MfDorPress <- extractVals(mfPDat, mfPMod, otherConfigs, baseline, 'mfDorsalPressure', 'higher')

es_MfDorPress <- EffectSizeLM(mfPDat, 'mfDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_MfDorPress, es_MfDorPress, baseline)
...
ev_FfDorPress <- extractVals(ffPDat, ffPMod, otherConfigs, baseline, 'ffDorsalPressure', 'higher')

es_FfDorPress <- EffectSizeLM(ffPDat, 'ffDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_FfDorPress, es_FfDorPress, baseline)
```
