...
ggplot(data = dat, aes(x = m_heelPP, fill = Label)) + geom_histogram() + facet_wrap(~Subject)
...
ggplot(data = dat, aes(x = m_toePP, fill = Label)) + geom_histogram() + facet_wrap(~Subject)

ggplot(data = dat, aes(x = avg_toe_med)) + geom_histogram() + facet_wrap(~Subject)

ggplot(data = dat, aes(x = ToeCon, fill = Label)) + geom_histogram() + facet_wrap(~Subject)
...
withinSubPlot(dat1, colName = 'ToeCon', dir = 'higher','Toe Contact (%)')
withinSubPlot(dat2, colName = 'ToeCon', dir = 'higher','Toe Contact (%)') 
withinSubPlot(dat3, colName = 'ToeCon', dir = 'higher','Toe Contact (%)') 
