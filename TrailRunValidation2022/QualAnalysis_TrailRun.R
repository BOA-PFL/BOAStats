...
qualDat <- read_xlsx('C:/Users/eric.honert/Boa Technology Inc/PFL Team - General/Testing Segments/EndurancePerformance/TrailRun_2022/TrailRunQual.xlsx','RPE')
...
testAnova('Uphill',qualDat)
testAnova('Level',qualDat)
testAnova('Downhill',qualDat)
