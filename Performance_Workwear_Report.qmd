...
ev_Torque <- extractVals(torqueDat , torqueMod, otherConfigs, baseline, 'L_DialTorque1', 'higher')

es_Torque <- EffectSizeLM(torqueDat, 'L_DialTorque1 ~ Config + (1|Subject)')
checkEffectMagnitude(ev_Torque, es_Torque, baseline)
```
...
ev_Speed <- extractVals(Speeddat, SpeeddatMod, otherConfigs, baseline, 'imuSpeed', 'higher')

es_Speed <- EffectSizeLM(Speeddat,'imuSpeed ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_Speed, es_Speed, baseline)
```
...
ev_PeakToeWalk <- extractVals(PeakToeWalkdat, PeakToeWalkdatMod, otherConfigs, baseline, 'maxmaxToes', 'lower')

es_PeakToeWalk <- EffectSizeLM(PeakToeWalkdat, 'maxmaxToes ~ Config + Movement + (Config|Subject)')
checkEffectMagnitude(ev_PeakToeWalk, es_PeakToeWalk, baseline)
...
ev_PeakToeLand <- extractVals(PeakToeLanddat, PeakToeLanddatMod, otherConfigs, baseline, 'ToeClawPeak', 'lower')

es_PeakToeLand <- EffectSizeLM(PeakToeLanddat, 'ToeClawPeak ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_PeakToeLand, es_PeakToeLand, baseline)
```
...
ev_PeakToeUH <- extractVals(PeakToeUH, PeakToeUHMod, otherConfigs, baseline, 'maxmaxToes', 'lower')

es_PeakToeUH <- EffectSizeLM(PeakToeUH, 'maxmaxToes ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_PeakToeUH, es_PeakToeUH, baseline)
...
ev_PeakToeDH <- extractVals(PeakToeDH, PeakToeDHMod, otherConfigs, baseline, 'maxmaxToes', 'lower')

es_PeakToeDH <- EffectSizeLM(PeakToeDH, 'maxmaxToes ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_PeakToeDH, es_PeakToeDH, baseline)
...
ev_PeakToeTr <- extractVals(PeakToeTr, PeakToeTrMod, otherConfigs, baseline, 'maxmaxToes', 'lower')

es_PeakToeTr <- EffectSizeLM(PeakToeTr, 'maxmaxToes ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_PeakToeTr, es_PeakToeTr, baseline)
...
ev_RFD <- extractVals(RFDSUDat, RFDSUDatMod, otherConfigs, baseline, 'RFD', 'higher')

es_RFD <- EffectSizeLM(RFDSUDat, 'RFD ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_RFD, es_RFD, baseline)
```
...
ev_COP <- extractVals(COPSUDat, COPSUDatMod, otherConfigs, baseline, 'COPEx', 'lower')

es_COP <- EffectSizeLM(COPSUDat, 'COPEx ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_COP, es_COP, baseline)
...
ev_psCOM_UH <- extractVals(psCOM_UH, psCOM_UH_mod, otherConfigs, baseline, 'COMWork_pos', 'lower')

es_psCOM_UH <- EffectSizeLM(psCOM_UH, 'COMWork_pos ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_psCOM_UH, es_psCOM_UH, baseline)
```
...
ev_ngCOM_DH <- extractVals(ngCOM_DH, ngCOM_DH_mod, otherConfigs, baseline, 'COMWork_neg', 'higher')

es_ngCOM_DH <- EffectSizeLM(ngCOM_DH, 'COMWork_neg ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_ngCOM_DH, es_ngCOM_DH, baseline)
```
...
ev_Eversion <- extractVals(Everdat, EverdatMod, otherConfigs, baseline, 'pIEgyro', 'lower')

es_Eversion <- EffectSizeLM(Everdat, 'pIEgyro ~ Config + imuSpeed + (Config|Subject)')
checkEffectMagnitude(ev_Eversion, es_Eversion, baseline)
```
...
ev_KneeABD <- extractVals(KABDSUDat, KABDSUDatMod, otherConfigs, baseline, 'RkneeABDMom', 'higher')

es_KneeABD <- EffectSizeLM(KABDSUDat, 'RkneeABDMom ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_KneeABD, es_KneeABD, baseline)
```
...
ev_AnkleEv <- extractVals(AEMSUDat, AEMSUDatMod, otherConfigs, baseline, 'RankleEvMom', 'higher')

es_AnkleEv <- EffectSizeLM(AEMSUDat, 'RankleEvMom ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_AnkleEv, es_AnkleEv, baseline)
```
...
ev_AnkleEv2 <- extractVals(AEMSUDat, AEMSUDatMod, otherConfigs, baseline, 'RankleEvMom', 'higher')

es_AnkleEv2 <- EffectSizeLM(AEMSUDat, 'RankleEvMom ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_AnkleEv2, es_AnkleEv2, baseline)
...
ev_StabTime <- extractVals(TimeUnLandDat, TimeUnLandDatMod, otherConfigs, baseline, 'StabTime', 'lower')

es_StabTime <- EffectSizeLM(TimeUnLandDat, 'StabTime ~ Config + Order + (Config|Subject)')
checkEffectMagnitude(ev_StabTime, es_StabTime, baseline)
```
...
ev_HeelContact <- extractVals(HeelCondat, HeelCondatMod, otherConfigs, baseline, 'heelAreaP', 'higher')

es_HeelContact <- EffectSizeLM(HeelCondat, 'heelAreaP ~ Config + Movement + (Config|Subject)')
...
ev_HeelContactDH <- extractVals(DHCondat, DHCondatMod, otherConfigs, baseline, 'heelAreaP', 'higher')

es_HeelContactDH <- EffectSizeLM(DHCondat, 'heelAreaP ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_HeelContactDH, es_HeelContactDH, baseline)

p <- withinSubPlotAvg(UHCondat, colName = 'heelAreaP', dir = 'higher')
p + ylab('Uphill - Heel Contact (%)')

ev_HeelContactUH <- extractVals(UHCondat, UHCondatMod, otherConfigs, baseline, 'heelAreaP', 'higher')

es_HeelContactUH <- EffectSizeLM(UHCondat, 'heelAreaP ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_HeelContactUH, es_HeelContactUH, baseline)

p <- withinSubPlotAvg(TCondat, colName = 'heelAreaP', dir = 'higher')
p + ylab('Trail - Heel Contact (%)')

ev_HeelContactTrail <- extractVals(TCondat, TCondatMod, otherConfigs, baseline, 'heelAreaP', 'higher')

es_HeelContactTrail <- EffectSizeLM(TCondat, 'heelAreaP ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_HeelContactTrail, es_HeelContactTrail, baseline)
```
...
ev_MaxDorsal <- extractVals(peakDorsal, DorsalMaxMod, otherConfigs, baseline, 'maxDorsalPressure', 'lower')

es_MaxDorsal <- EffectSizeLM(peakDorsal, 'maxDorsalPressure ~ Config + (1|Subject)')
...
ev_MeanDorsal <- extractVals(avgDorsal, DorsalMeanMod, otherConfigs, baseline, 'meanDorsalPressure', 'higher')

es_MeanDorsal <- EffectSizeLM(avgDorsal, 'meanDorsalPressure ~ Config + (1|Subject)')
checkEffectMagnitude(ev_MeanDorsal, es_MeanDorsal, baseline)
