...
ev_BracePos <- extractVals(zscoreDat,
zscore_runmod_brace , otherConfigs, baseline, 'RKneeBrace_VertPos', 'higher')

es_BracePos <- EffectSizeLM(zscoreDat, 'RKneeBrace_VertPos ~ Config + (1 + Config|Subject)')

checkEffectMagnitude(ev_BracePos, es_BracePos, baseline)
...
ev_ExtMomCMJ <- extractVals(jointDat,
runmod_cmj, otherConfigs, baseline, 'peakKneeEXTmom', 'higher')

es_ExtMomCMJ <- EffectSizeLM(jointDat, 'peakKneeEXTmom ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_ExtMomCMJ, es_ExtMomCMJ, baseline)
...
ev_KneeFlexCMJ <- extractVals(kneeflexcmjDat,
kneeflexcmjMod, otherConfigs, baseline, 'kneeFLEXrom', 'higher')

es_KneeFlexCMJ <- EffectSizeLM(kneeflexcmjDat, 'kneeFLEXrom ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_KneeFlexCMJ, es_KneeFlexCMJ, baseline)
...
ev_AbMomCMJ <- extractVals(abMomecmjDat,
abMomecmjMod, otherConfigs, baseline, 'PeakKneeAbMoment', 'lower')

es_AbMomCMJ <- EffectSizeLM(abMomecmjDat, 'PeakKneeAbMoment ~ Trial + Config + (1 + Config|Subject)')

checkEffectMagnitude(ev_AbMomCMJ, es_AbMomCMJ, baseline)
...
ev_FRomCMJ <- extractVals(fRomcmjDat,
fRomcmjMod, otherConfigs, baseline, 'kneeABDrom', 'lower')

es_FRomCMJ <- EffectSizeLM(fRomcmjDat, 'kneeABDrom ~ Trial + Config + (1 + Config|Subject)')

checkEffectMagnitude(ev_FRomCMJ, es_FRomCMJ, baseline)
...
ev_ExtMomSkate <- extractVals(extmome_Skate,
extMome_skateMod, otherConfigs, baseline, 'peakKneeEXTmom', 'higher')

es_ExtMomSkate <- EffectSizeLM(extmome_Skate, 'peakKneeEXTmom ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_ExtMomSkate, es_ExtMomSkate, baseline)
```
...
ev_SagROMSkate <- extractVals(sagROMskate,
sagROMskateMod, otherConfigs, baseline, 'kneeFLEXrom', 'higher')

es_SagROMSkate <- EffectSizeLM(sagROMskate, 'kneeFLEXrom ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_SagROMSkate, es_SagROMSkate, baseline)
...
ev_AbMomSkate <- extractVals(abmomeSkate,
abmomeSkateMod, otherConfigs, baseline, 'PeakKneeAbMoment', 'lower')

es_AbMomSkate <- EffectSizeLM(abmomeSkate, 'PeakKneeAbMoment ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_AbMomSkate, es_AbMomSkate, baseline)
...
ev_FRomSkate <- extractVals(fRomSkate,
fRomSkateMod, otherConfigs, baseline, 'kneeABDrom', 'lower')

es_FRomSkate <- EffectSizeLM(fRomSkate, 'kneeABDrom ~ Trial + Config + (Config|Subject)')

checkEffectMagnitude(ev_FRomSkate, es_FRomSkate, baseline)
