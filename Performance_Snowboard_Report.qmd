...
imuDat <- read.csv('C:\\Users\\bethany.kilpatrick\\BOA Technology Inc\\PFL Team - General\\Testing Segments\\Snow Performance\\2025_Mech_LowZonePFW_Ride\\IMU\\1_IMUOutcomes.csv')

# Pressure from Insoles - during carving
pressDat <- read.csv('C:\\Users\\bethany.kilpatrick\\BOA Technology Inc\\PFL Team - General\\Testing Segments\\Snow Performance\\2025_Mech_LowZonePFW_Ride\\Xsensor\\Exported\\0_CompiledResults_7.csv')
...
toeRFDdat<- subset(toeRFDdat, toeRFDdat$z_score < 2) #removing outliers
toeRFDdat<- subset(toeRFDdat, toeRFDdat$z_score > -2)
