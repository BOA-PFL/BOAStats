...
p <- withinSubPlot(avgDat, colName = 'AvgSpeed', dir = 'higher')
...
p <- withinSubPlot(topDat, colName = 'TopSpeed', dir = 'higher')
...
p <- withinSubPlot(heelFdat, colName = 'HeelTotMaxForce', dir = 'higher')
...
p <- withinSubPlot(heelEdat, colName = 'BoardAngle_HeelTurns', dir = 'higher')
...
p <- withinSubPlot(toeEdat, colName = 'BoardAngle_ToeTurns', dir = 'higher')
p + ylab('Board Angle (deg)')
...
p <- withinSubPlot(heelRFDdat, colName = 'RFD', dir = 'higher')
p + ylab('RFD (N/s)')
...
p <- withinSubPlot(toeRFDdat, colName = 'RFD', dir = 'higher')
p + ylab('RFD (N/s)')
...
p <- withinSubPlot(heeldat, colName = 'heelAreaP', dir = 'higher')
...
p <- withinSubPlot(avgDorsaldat, colName = 'avgDorsal', dir = 'higher')
...
p <- withinSubPlot(varDorsaldat, colName = 'varDorsal', dir = 'lower')
...
p <- withinSubPlot(avgShindat, colName = 'avgShin', dir = 'higher')
...
p <- withinSubPlot(varShindat, colName = 'varShin', dir = 'lower')
...
p <- withinSubPlot(avgCalfdat, colName = 'avgCalf', dir = 'higher')
