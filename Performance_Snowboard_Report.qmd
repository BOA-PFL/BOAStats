...
p <- withinSubPlotAvg(avgDat, colName = 'AvgSpeed', dir = 'higher','Average Speed (kph)')

ev_AvgSpeed <- extractVals(avgDat, avgMod, otherConfigs, baseline, 'AvgSpeed', 'higher')

es_AvgSpeed <- EffectSizeLM(avgDat,'AvgSpeed ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_AvgSpeed, es_AvgSpeed, baseline)
```
...
p <- withinSubPlotAvg(topDat, colName = 'TopSpeed', dir = 'higher','Top Speed (kph)')

ev_TopSpeed <- extractVals(topDat, topMod, otherConfigs, baseline, 'TopSpeed', 'higher')

es_TopSpeed <- EffectSizeLM(topDat, 'TopSpeed ~ Config + (Config|Subject)')
checkEffectMagnitude(ev_TopSpeed, es_TopSpeed, baseline)
```
...
p <- withinSubPlotAvg(heelFdat, colName = 'HeelTotMaxForce', dir = 'higher','Heel Edge Force (N)')

ev_HeelTotMaxForce <- extractVals(heelFdat, heelFmod, otherConfigs, baseline, 'HeelTotMaxForce', 'higher')

es_HeelTotMaxForce <- EffectSizeLM(heelFdat, 'HeelTotMaxForce ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_HeelTotMaxForce, es_HeelTotMaxForce, baseline)
```
...
p <- withinSubPlotAvg(toeFdat, colName = 'ToeTotMaxForce', dir = 'higher','Toe Edge Force (N)')

ev_ToeTotMaxForce <- extractVals(toeFdat, toeFmod, otherConfigs, baseline, 'ToeTotMaxForce', 'higher')

es_ToeTotMaxForce <- EffectSizeLM(toeFdat, 'ToeTotMaxForce ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_ToeTotMaxForce, es_ToeTotMaxForce, baseline)
```
...
p <- withinSubPlotAvg(heelEdat, colName = 'BoardAngle_HeelTurns', dir = 'higher', 'Board Angle (deg)')

ev_BoardAngle_HeelTurns <- extractVals(heelEdat, heelEmod, otherConfigs, baseline, 'BoardAngle_HeelTurns', 'higher')

es_BoardAngle_HeelTurns <- EffectSizeLM(heelEdat, 'BoardAngle_HeelTurns ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_BoardAngle_HeelTurns, es_BoardAngle_HeelTurns, baseline)
```
...
p <- withinSubPlotAvg(toeEdat, colName = 'BoardAngle_ToeTurns', dir = 'higher','Board Angle (deg)')

ev_BoardAngle_ToeTurns <- extractVals(toeEdat, toeEmod, otherConfigs, baseline, 'BoardAngle_ToeTurns', 'higher')

es_BoardAngle_ToeTurns <- EffectSizeLM(toeEdat, 'BoardAngle_ToeTurns ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_BoardAngle_ToeTurns, es_BoardAngle_ToeTurns, baseline)
```
...
p <- withinSubPlotAvg(heelRFDdat, colName = 'RFD', dir = 'higher','RFD (N/s)')


ev_HeelRFD <- extractVals(heelRFDdat, heelRFDmod, otherConfigs, baseline, 'RFD', 'higher')

es_HeelRFD <- EffectSizeLM(heelRFDdat, 'RFD ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_HeelRFD, es_HeelRFD, baseline)
```
...
withinSubPlotAvg(toeRFDdat, colName = 'RFD', dir = 'higher','Toe Turns RFD (N/s)' )

ev_ToeRFD <- extractVals(toeRFDdat, toeRFDmod, otherConfigs, baseline, 'RFD', 'higher')

es_ToeRFD <- EffectSizeLM(toeRFDdat, 'RFD ~ Config + (1 + Config|Subject)')
checkEffectMagnitude(ev_ToeRFD, es_ToeRFD, baseline)
```
...
ev_heelAreaP <- extractVals(heeldat, heelmod, otherConfigs, baseline, 'heelAreaP', 'higher')

es_heelAreaP <- EffectSizeLM(heeldat, 'heelAreaP ~ Config + ToeTotMaxForce + (1 + Config|Subject)')
checkEffectMagnitude(ev_heelAreaP, es_heelAreaP, baseline)
```
...
ev_avgDorsal <- extractVals(avgDorsaldat, avgDorsalmod, otherConfigs, baseline, 'avgDorsal', 'higher')

es_avgDorsal <- EffectSizeLM(avgDorsaldat, 'avgDorsal ~ Config + (Config|Subject)')
...
ev_varDorsal <- extractVals(varDorsaldat, varDorsalmod, otherConfigs, baseline, 'varDorsal', 'lower')

es_varDorsal <- EffectSizeLM(varDorsaldat, 'varDorsal ~ Config + (Config|Subject)')
