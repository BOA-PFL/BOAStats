...
|                  |                     |                               | -   Forefoot pressure        |
+------------------+---------------------+-------------------------------+------------------------------+
|                  | Vertical CMJ        | In-ground force plates        | Power Transfer:              |
|                  |                     |                               |                              |
...
|                  |                     |                               | -   Peak Ankle Force         |
+------------------+---------------------+-------------------------------+------------------------------+
|                  | Lateral Skater Jump | Force plates & Motion Capture | Stability & Control          |
|                  |                     |                               |                              |
|                  |                     |                               | -   Peak Ankle Velocity      |
|                  |                     |                               |                              |
...
dialTorque<- read_xlsx('C:\\Users\\bethany.kilpatrick\\BOA Technology Inc\\PFL Team - General\\Testing Segments\\AgilityPerformanceData\\2025_Performance_HeadEnduroPerformance_Head\\DialTorque.xlsx')

dialTorque$Config <- factor(dialTorque$Config, allConfigs)

torqPress <- list(Press,dialTorque) %>%
  reduce(full_join)%>% 
  filter(Config != 'Lace')
