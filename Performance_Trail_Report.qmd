...
ev_HR1 <- extractVals(HRdat1, HRdat1Mod, otherConfigs, baseline, 'AvgHRS1', 'lower')

ev_HR2 <- extractVals(HRdat2, HRdat2Mod, otherConfigs, baseline, 'AvgHRS2', 'lower')

es_HR2 <- EffectSizeLM(HRdat2, 'AvgHRS2 ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_HR2, es_HR2, baseline)

ev_HR3 <- extractVals(HRdat3, HRdat3Mod, otherConfigs, baseline, 'AvgHRS3', 'lower')

es_HR3 <- EffectSizeLM(HRdat3, 'AvgHRS3 ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_HR3, es_HR3, baseline)

p <- withinSubPlotAvg(HRdat1, colName = 'AvgHRS1', dir = 'lower')
p + ylab('Uphill Heart Rate (bpm)')

es_HR1 <- EffectSizeLM(HRdat1,'AvgHRS1 ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_HR1, es_HR1, baseline)
...
ev_Speed1 <- extractVals(Speeddat1, Speeddat1Mod, otherConfigs, baseline, 'imuSpeed', 'higher')

es_Speed1 <- EffectSizeLM(Speeddat1, 'imuSpeed ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Speed1, es_Speed1, baseline)

ev_Speed2 <- extractVals(Speeddat2, Speeddat2Mod, otherConfigs, baseline, 'imuSpeed', 'higher')

es_Speed2 <- EffectSizeLM(Speeddat2, 'imuSpeed ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Speed2, es_Speed2, baseline)

ev_Speed3 <- extractVals(Speeddat3, Speeddat3Mod, otherConfigs, baseline, 'imuSpeed', 'higher')

es_Speed3 <- EffectSizeLM(Speeddat3, 'imuSpeed ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Speed3, es_Speed3, baseline)
...
ev_Ever1 <- extractVals(Everdat1, Everdat1Mod, otherConfigs, baseline, 'pIEgyro', 'lower')

es_Ever1 <- EffectSizeLM(Everdat1, 'pIEgyro ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Ever1, es_Ever1, baseline)

ev_Ever2 <- extractVals(Everdat2, Everdat2Mod, otherConfigs, baseline, 'pIEgyro', 'lower')

es_Ever2 <- EffectSizeLM(Everdat2, 'pIEgyro ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Ever2, es_Ever2, baseline)

ev_Ever3 <- extractVals(Everdat3, Everdat3Mod, otherConfigs, baseline, 'pIEgyro', 'lower')

es_Ever3 <- EffectSizeLM(Everdat3, 'pIEgyro ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Ever3, es_Ever3, baseline)
...
ev_Heel1 <- extractVals(HeelCondat1, HeelCondat1Mod, otherConfigs, baseline, 'HeelCon', 'higher')

es_Heel1 <- EffectSizeLM(HeelCondat1, 'HeelCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Heel1, es_Heel1, baseline)

ev_Heel2 <- extractVals(HeelCondat2, HeelCondat2Mod, otherConfigs, baseline, 'HeelCon', 'higher')

es_Heel2 <- EffectSizeLM(HeelCondat2, 'HeelCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Heel2, es_Heel2, baseline)

ev_Heel3 <- extractVals(HeelCondat3, HeelCondat3Mod, otherConfigs, baseline, 'HeelCon', 'higher')

es_Heel3 <- EffectSizeLM(HeelCondat3, 'HeelCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Heel3, es_Heel3, baseline)
...
ev_Fore1 <- extractVals(ForeCondat1, ForeCondat1Mod, otherConfigs, baseline, 'MetCon', 'higher')

es_Fore1 <- EffectSizeLM(ForeCondat1, 'MetCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Fore1, es_Fore1, baseline)

ev_Fore2 <- extractVals(ForeCondat2, ForeCondat2Mod, otherConfigs, baseline, 'MetCon', 'higher')

es_Fore2 <- EffectSizeLM(ForeCondat2, 'MetCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Fore2, es_Fore2, baseline)

ev_Fore3 <- extractVals(ForeCondat3, ForeCondat3Mod, otherConfigs, baseline, 'MetCon', 'higher')

es_Fore3 <- EffectSizeLM(ForeCondat3, 'MetCon ~ Config + (Config|Subject)')

checkEffectMagnitude(ev_Fore3, es_Fore3, baseline)
